...
<body>
<!-- BbsDto dto 에서 불러온 값을 받기-->
<%	
	BbsDto dto = (BbsDto)request.getAttribute("bbsdto"); /* 짐싸는이름 */
%>
<h1>글보긔</h1>
<hr>
...
<!--session에서 MemberDto형태로 로그인정보 받아온거 -->
<%
...
$(document).ready(function(){ 
	$.ajax({
		url:"./commentList.do",//댓글쓴거 보여주기
		type:"get",
		data:{ "seq":<%=dto.getSeq() %> }, //보낼 데이터
		success:function(list){ //받아오는 list값
			// alert('success');
